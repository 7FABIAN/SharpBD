namespace ejemploBd
{
	partial class GestionModulos
	{
		...
		private void InitializeComponent()
		{
			...
			// Verpreguntas
			// 
			this.Verpreguntas.Location = new System.Drawing.Point(110, 240);
			this.Verpreguntas.Name = "Verpreguntas";
			this.Verpreguntas.Size = new System.Drawing.Size(131, 23);
			this.Verpreguntas.TabIndex = 4;
			this.Verpreguntas.Text = "Ver preguntas";
			this.Verpreguntas.UseVisualStyleBackColor = true;
			this.Verpreguntas.Click += new System.EventHandler(this.VerpreguntasClick);
			// 
			// GestionModulos
			// 
